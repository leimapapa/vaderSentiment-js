...
class SentimentIntensityAnalyzer {
  ...
  */
  ...
  // EXPOSE
  sentiment_valence(valence, sentiText, item, index, sentiments) {
  ...
  // EXPOSE
  least_check(valence, words_and_emoticons, index) {
    /**
  ...
  // EXPOSE
  but_check(words_and_emoticons, sentiments) {
    /**
  ...
  // EXPOSE
  idioms_check(valence, words_and_emoticons, index) {
  ...
  // EXPOSE
  never_check(valence, words_and_emoticons, start_i, index) {
    if (start_i === 0) {
  ...
  // EXPOSE
  punctuation_emphasis(sum_s, text) {
    /**
  ...
  // EXPOSE
  sift_sentiment_scores(sentiments) {
    /**
